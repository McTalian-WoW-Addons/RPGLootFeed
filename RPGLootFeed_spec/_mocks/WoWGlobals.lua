...
stub(_G.UIParent, "CreateFontString", function()
	...
	stub(fontString, "ClearAllPoints")
	stub(fontString, "SetDrawLayer")
	stub(fontString, "SetShadowColor")
	stub(fontString, "SetShadowOffset")
	stub(fontString, "Show")
	stub(fontString, "IsShown")
